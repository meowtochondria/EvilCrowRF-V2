...
| M5: Delete BleProvider | ✅ Done. BleConnectionProvider (522 lines) at lib/connection/ble_connection_provider.dart replaces the 5151-line BleProvider god object. All 11 consumer files migrated: transmit_file_dialog, file_list_widget, subghz_clone_dialog, quick_connect_widget, status_bar_widget, home_screen, debug_screen, settings_screen. ConnectionStateProvider simplified (no more dual BLE provider tracking). ble_provider.dart deleted. |
