...
import 'file_viewer/file_viewer_parsed_tab.dart';
...
class _FileViewerScreenState extends State<FileViewerScreen>
  ...
  Widget _buildParsedTab() {
    return FileViewerParsedTab(parseResult: parseResult);
  }

  // _buildParsedTab body extracted to
  // screens/file_viewer/file_viewer_parsed_tab.dart (M4 of refactor.md).
  Widget _buildRawTab() {
